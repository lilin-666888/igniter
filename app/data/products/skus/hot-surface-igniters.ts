  ...
  sections: [
    {
      ...
      groups: [
        {
          label: 'Gas Hot Surface Igniters',
          labelVariant: 'gas',
          note: 'Gas furnaces · water heaters · boilers · HVAC',
          items: [
            {
              model: 'Gas HSI / 120',
        ...
        {
          label: 'Fuel Hot Surface Igniters',
          labelVariant: 'fuel',
          note: 'Pellet stoves · oil boilers · biomass · kerosene',
          items: [
            {
              model: 'Fuel HSI / 230',
    ...
    {
      type: 'cert-grid',
      num: '04 · Certifications & Compliance',
