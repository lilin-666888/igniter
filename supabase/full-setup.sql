...
insert into public.site_settings (key, value) values ('contact_info', '{"email":"sales@ceramitell.com","phone":"+86 151 9017 9780","display":"sales@ceramitell.com · +86 151 9017 9780"}'::jsonb) on conflict (key) do update set value = excluded.value, updated_at = now();
